...
import com.ultra.megamod.lib.owo.config.annotation.Config;
import com.ultra.megamod.lib.owo.config.annotation.Hook;
import com.ultra.megamod.lib.owo.config.annotation.Nest;
...
@ApiStatus.Internal
@SupportedAnnotationTypes("com.ultra.megamod.lib.owo.config.annotation.Config")
...
public class ConfigAP extends AbstractProcessor {
    ...
    private static final String WRAPPER_TEMPLATE = """
            ...
            import com.ultra.megamod.lib.owo.config.ConfigWrapper.BuilderConsumer;
