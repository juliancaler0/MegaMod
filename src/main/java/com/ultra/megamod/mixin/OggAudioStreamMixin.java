...
import com.ultra.megamod.feature.ambientsounds.sound.OggAudioStreamExtended;
            ...
            try {
                for (int i = 0; i < 2; i++) {
                    ...
                    if (!((JOrbisAudioStream) (Object) this).readChunk(x -> {})) {
                        AmbientSoundsFeature.LOGGER.error("Possibly reached end of file {}/{}", skipped, length);
                        return false;
                    }
                }
                ...
                try {
                    ...
                    AmbientSoundsFeature.LOGGER.error("Failed to play sound with offset {}/{}", skipped, length);
                    AmbientSoundsFeature.LOGGER.error("", e2);
                    return false;
                }
                continue;
            }
