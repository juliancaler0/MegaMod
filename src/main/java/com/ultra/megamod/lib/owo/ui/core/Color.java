...
public record Color(float red, float green, float blue, float alpha) implements Animatable<Color> {
    ...
    public com.ultra.megamod.lib.owo.braid.core.Color toBraid() {
        return com.ultra.megamod.lib.owo.braid.core.Color.values(this.red, this.green, this.blue, this.alpha);
    }
