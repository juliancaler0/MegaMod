...
public class HudKeyVisuals {
    private static final Drawable.Texture mouseTexture = new Drawable.Texture(Identifier.fromNamespaceAndPath(CombatRollMod.ID, "textures/hud/combatroll_widgets.png"), 256, 256);
