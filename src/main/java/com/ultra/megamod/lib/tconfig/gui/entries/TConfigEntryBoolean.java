...
public class TConfigEntryBoolean extends TConfigEntryValue<Boolean> {
    ...
    public TConfigEntryBoolean(String translationKey, @Nullable String tooltip, Supplier<Boolean> getter, Consumer<Boolean> setter, boolean defaultValue) {
    ...
    public TConfigEntryBoolean(String translationKey, Supplier<Boolean> getter, Consumer<Boolean> setter, boolean defaultValue) {
