...
public class TConfigEntryText extends TConfigEntry {
    ...
    public static Collection<TConfigEntry> fromLongOrMultilineTranslation(String translationKey, int width) {
        return fromLongOrMultilineTranslation(translationKey, width, TextAlignment.CENTER);
    }

    public static List<TConfigEntry> fromLongOrMultilineTranslation(String translationKey, int width, TextAlignment alignment) {
