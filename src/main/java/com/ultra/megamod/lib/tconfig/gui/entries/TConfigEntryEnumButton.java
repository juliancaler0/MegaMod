...
public class TConfigEntryEnumButton<E extends Enum<E>> extends TConfigEntryNullSafe<E> {
    ...
    public TConfigEntryEnumButton(String text, String tooltip, Supplier<E> getter, Consumer<E> setter, E defaultValue, Class<E> enumClass) {
    ...
    public TConfigEntryEnumButton(String text, String tooltip, Supplier<E> getter, Consumer<E> setter, @NotNull E defaultValue) {
        this(text, tooltip, getter, setter, defaultValue, defaultValue.getDeclaringClass());
    }

    @SuppressWarnings("unused")
    public TConfigEntryEnumButton(String text, Supplier<E> getter, Consumer<E> setter, E defaultValue, Class<E> enumClass) {
        this(text, null, getter, setter, defaultValue, enumClass);
    }

    @SuppressWarnings("unused")
    public TConfigEntryEnumButton(String text, Supplier<E> getter, Consumer<E> setter, @NotNull E defaultValue) {
