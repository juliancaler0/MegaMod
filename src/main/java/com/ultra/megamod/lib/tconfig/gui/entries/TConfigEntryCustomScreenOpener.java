...
public class TConfigEntryCustomScreenOpener extends TConfigEntry {
    ...
    public TConfigEntryCustomScreenOpener(final String text, final String tooltip, Supplier<Screen> screenSupplier, Supplier<Boolean> savedSupplier, Runnable setValuesDefault, Runnable resetValuesToInitial, boolean screenIsSingleton) {
        super(text, tooltip);
    ...
    public TConfigEntryCustomScreenOpener(final String text, Supplier<Screen> screenSupplier, Supplier<Boolean> savedSupplier, Runnable setValuesDefault, Runnable resetValuesToInitial, boolean screenIsSingleton) {
        this(text, null, screenSupplier, savedSupplier, setValuesDefault, resetValuesToInitial, screenIsSingleton);
    }

    public TConfigEntryCustomScreenOpener(final String text, final String tooltip, Supplier<Screen> screenSupplier, boolean screenIsSingleton) {
        this(text, tooltip, screenSupplier, () -> false, () -> {}, () -> {}, screenIsSingleton);
    }

    @SuppressWarnings("unused")
    public TConfigEntryCustomScreenOpener(final String text, Supplier<Screen> screenSupplier, boolean screenIsSingleton) {
