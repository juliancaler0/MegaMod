...
public class TConfigEntryCustomButton extends TConfigEntry {
    ...
    public TConfigEntryCustomButton(final String text, final String tooltip, Button.OnPress action) {
        super(text, tooltip);
        this.button = Button.builder(getText(), action).bounds(0, 0, 0, 0).tooltip(getTooltip()).build();
    }

    @SuppressWarnings("unused")
    public TConfigEntryCustomButton(final String text, Button.OnPress button) {
