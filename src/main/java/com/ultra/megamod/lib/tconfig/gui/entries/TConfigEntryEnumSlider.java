...
public class TConfigEntryEnumSlider<E extends Enum<E>> extends TConfigEntryNullSafe<E> {
    ...
    public TConfigEntryEnumSlider(String text, String tooltip, Supplier<E> getter, Consumer<E> setter, E defaultValue, Class<E> enumClass) {
    ...
    public TConfigEntryEnumSlider(String text, String tooltip, Supplier<E> getter, Consumer<E> setter, @NotNull E defaultValue) {
        this(text, tooltip, getter, setter, defaultValue, defaultValue.getDeclaringClass());
    }

    @SuppressWarnings("unused")
    public TConfigEntryEnumSlider(String text, Supplier<E> getter, Consumer<E> setter, @NotNull E defaultValue) {
        this(text, null, getter, setter, defaultValue, defaultValue.getDeclaringClass());
    }

    @SuppressWarnings("unused")
    public TConfigEntryEnumSlider(String text, Supplier<E> getter, Consumer<E> setter, E defaultValue, Class<E> enumClass) {
