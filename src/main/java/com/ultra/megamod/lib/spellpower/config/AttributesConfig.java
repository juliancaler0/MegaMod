package com.ultra.megamod.lib.spellpower.config;

import com.ultra.megamod.lib.spellpower.api.DamageCurve;
...
public class AttributesConfig {
    ...
    public static AttributesConfig defaults() {
        ...
        config.secondary_effects = Map.of(
                "sp_critical_chance", new EffectConfig(0.05F),
                "sp_critical_damage", new EffectConfig(0.1F),
                "sp_haste", new EffectConfig(0.05F)
        );
        return config;
    }
