...
/**
 * Semantic-version range predicate. Ported 1:1 from Entity_Texture_Features (traben).
 */
public abstract class SemVerRangeFromStringArrayProperty extends NumberRangeFromStringArrayProperty<SemVerRangeFromStringArrayProperty.SemVerNumber> {
    ...
    @Override
    protected @Nullable RangeTester<SemVerNumber> getRangeTesterFromString(String possibleRange) {
        try {
