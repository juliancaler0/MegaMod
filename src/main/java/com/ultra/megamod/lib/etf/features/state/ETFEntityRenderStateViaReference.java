...
/**
 * Default {@link ETFEntityRenderState} implementation that smuggles a live {@link ETFEntity}
 * reference and delegates each accessor to it.
 * <p>
 * Ported 1:1 from Entity_Texture_Features (traben). Upstream notes that the entity-smuggling
 * approach is a stop-gap for 1.21+ vanilla render states; downstream consumers can swap a
 * cached implementation via {@link ETFEntityRenderState#setEtfRenderStateConstructor(String, ETFEntityRenderState.ETFRenderStateInit)}.
 */
