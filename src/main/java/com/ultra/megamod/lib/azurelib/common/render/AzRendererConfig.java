...
public class AzRendererConfig<K, T> {
    ...
    private final @Nullable Function<AzBone, Identifier> boneTextureOverrideProvider;
    ...
    public static class Builder<K, T> {
        ...
        private @Nullable Function<AzBone, Identifier> boneTextureOverrideProvider;
        ...
        protected Builder(
            ...
            this.renderTypeProvider = (a, b) -> RenderTypes.entityCutout(textureLocationProvider.apply(a, b));
