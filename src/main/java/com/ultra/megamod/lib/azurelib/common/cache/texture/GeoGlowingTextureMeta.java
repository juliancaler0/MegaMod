...
import com.ultra.megamod.lib.azurelib.common.render.layer.AzAutoGlowingLayer;
...
public class GeoGlowingTextureMeta {
    ...
    /**
     * Metadata section deserializer for glowsection mcmeta data.
     */
    public static final MetadataSectionType<GeoGlowingTextureMeta> DESERIALIZER =
        new MetadataSectionType<>("glowsections", com.mojang.serialization.MapCodec.unit(new GeoGlowingTextureMeta()).codec());

    private final List<Pixel> pixels;

    /** Default constructor for codec deserialization */
    private GeoGlowingTextureMeta() {
        this.pixels = List.of();
    }
    ...
    /**
     * Parse from a JsonObject manually (used when reading .mcmeta files with glowsections)
     */
    public static GeoGlowingTextureMeta fromJson(@NotNull JsonObject json) {
