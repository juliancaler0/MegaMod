...
public class AzBlockAndItemLayer<K, T> implements AzRenderLayer<K, T> {
    ...
    protected void renderItemForBone(
        ...
        // In 1.21.11, ItemRenderer.renderStatic was removed. Item rendering is now handled
        // by the new ItemStackRenderState system. This render call is stubbed for compatibility.
        // TODO: Re-implement using 1.21.11 item rendering API
    }
