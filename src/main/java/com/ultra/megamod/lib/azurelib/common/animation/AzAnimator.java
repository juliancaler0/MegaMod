...
import com.ultra.megamod.lib.azurelib.common.animation.controller.AzAnimationControllerContainer;
...
public abstract class AzAnimator<K, T> {
    ...
    protected void applyMolangQueries(T animatable, double animTime, float partialTicks) {
        ...
        parser.setMemoizedValue(MolangQueries.ACTOR_COUNT, () -> 0d);
        parser.setMemoizedValue(MolangQueries.TIME_OF_DAY, () -> level.getDayTime() / 24000f);
        parser.setMemoizedValue(MolangQueries.MOON_PHASE, () -> (double) ((int) (level.getDayTime() / 24000L % 8L + 8L) % 8));
    }
