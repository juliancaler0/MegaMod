...
public class EMFEntityRenderStateViaReference extends ETFEntityRenderStateViaReference implements EMFEntityRenderState {
    ...
    private Function<Identifier, RenderType> layerFactory = null;
    @Override
    public Function<Identifier, RenderType> layerFactory() {
        return layerFactory;
    }
    @Override
    public void setLayerFactory(final Function<Identifier, RenderType> layerFactory) {
