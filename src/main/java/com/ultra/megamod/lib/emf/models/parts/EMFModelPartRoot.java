...
import com.ultra.megamod.lib.emf.models.jem_objects.EMFJemData;
import com.ultra.megamod.lib.emf.models.jem_objects.EMFPartData;
...
import static com.ultra.megamod.lib.emf.EMFManager.getJemDataWithDirectory;
...
public class EMFModelPartRoot extends EMFModelPartVanilla {
    ...
    public void discoverAndInitVariants(String fallbackPropertiesName) {
        ...
        Identifier propertyID = directoryContext.getRelativeFilePossiblyEMFOverridden(directoryContext.rawFileName + ".properties");
        ...
        if (!exists && EMF.config().getConfig().allowOptifineFallbackProperties){
            Identifier fallbackPropertiesID = directoryContext.getRelativeFilePossiblyEMFOverridden(fallbackPropertiesName + ".properties");
...
//        }
    ...
    private Identifier jemLevelOverride = null;
