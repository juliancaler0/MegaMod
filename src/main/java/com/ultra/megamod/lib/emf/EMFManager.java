...
import com.ultra.megamod.lib.emf.mod_compat.EBEConfigModifier;
import com.ultra.megamod.lib.emf.models.EMFModelMappings;
import com.ultra.megamod.lib.emf.models.EMFModel_ID;
import com.ultra.megamod.lib.emf.models.EMFPartialArmor;
...
//        IS_IRIS_INSTALLED = EMFVersionDifferenceManager.isThisModLoaded("iris") || EMFVersionDifferenceManager.isThisModLoaded("oculus");
    ...
    public static EMFJemData getJemDataWithDirectory(EMFDirectoryHandler jemDirectory, EMFModel_ID mobModelIDInfo) {
        ...
        try {
            ...
            return jem;
        } catch (IdentifierException | FileNotFoundException e) {
    ...
    public ModelPart injectIntoModelRootGetter(final ModelLayerLocation layer, final ModelPart root) {
        ...
        try {
            ...
            if (!Identifier.isValidPath(mobNameForFileAndMap.getfileName() + ".jem")) {
