package com.ultra.megamod.lib.emf.models.jem_objects;

import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;
import com.ultra.megamod.lib.emf.EMF;
import com.ultra.megamod.lib.emf.EMFException;
import com.ultra.megamod.lib.emf.utils.EMFDirectoryHandler;
...
public class EMFJemData {
    ...
    private transient Identifier customTexture = null;
    ...
    @Nullable
    public Identifier validateJemTexture(String textureIn) {
        return validateJemTexture(textureIn, false);
    }

    @Nullable
    public Identifier validateJemTexture(String textureIn, boolean canRemoveRedundancy) {
        if (textureIn == null || textureIn.isBlank()) return null;

        Identifier res = validateResourcePathAndExists(textureIn, "png");
...
//        }
    ...
    @Nullable
    public Identifier validateResourcePathAndExists(String pathIn, @Nullable String fileTypeExtension) {
        ...
        */
        ...
        if (!pathTest.isBlank()) {
            ...
            if (
                Identifier.tryParse(pathTest) != null
            ) {
                Identifier possibleResource = EMFUtils.res(pathTest);
