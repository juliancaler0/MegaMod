package com.ultra.megamod.lib.emf.models.animation.math.variables;
...
import com.ultra.megamod.lib.emf.models.animation.math.MathConstant;
import com.ultra.megamod.lib.emf.models.animation.math.MathValue;
import com.ultra.megamod.lib.emf.models.animation.math.MathVariable;
import com.ultra.megamod.lib.emf.models.animation.math.variables.factories.*;
...
public final class VariableRegistry {
    ...
    public void registerSimpleFloatVariable(String variableName, String explanationTranslationKey, MathValue.ResultSupplier supplier) {
    ...
    public void registerSimpleBoolVariable(String variableName, String explanationTranslationKey, BooleanSupplier boolGetter) {
        if (singletonVariables.containsKey(variableName)) {
