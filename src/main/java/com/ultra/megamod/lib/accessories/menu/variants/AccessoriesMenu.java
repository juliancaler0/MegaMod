...
import com.ultra.megamod.lib.accessories.menu.*;
import com.ultra.megamod.lib.accessories.menu.networking.ToggledSlots;
// REMOVED: OWO SlotGenerator
...
public class AccessoriesMenu extends AccessoriesMenuBase {
    ...
    private static Container createEquipmentSlotContainer(LivingEntity living, EquipmentSlot equipmentSlot) {
        return new ContainerSingleItem() {
            ...
            public boolean stillValid(Player player) {
                return player.getVehicle() == living || player.distanceTo(living) <= 4.0;
            }
    ...
    protected boolean canMoveToAccessorySlot(ItemStack stack, LivingEntity living) {
        var capability = ((com.ultra.megamod.lib.accessories.pond.AccessoriesAPIAccess) living).accessoriesCapability();
