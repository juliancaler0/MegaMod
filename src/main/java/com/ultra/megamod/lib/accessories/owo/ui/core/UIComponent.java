...
public interface UIComponent extends PositionedRectangle {
     ...
     * Example:
     * <pre>
     * container.child(UIComponents.label(Text.of("Click")).&lt;LabelComponent&gt;configure(label -> {
     ...
     * exception is the {@link com.ultra.megamod.lib.accessories.owo.ui.container.DraggableContainer}
