...
import com.ultra.megamod.lib.accessories.owo.ui.event.WindowResizeCallback;
import com.ultra.megamod.lib.accessories.owo.ui.renderstate.CircleElementRenderState;
import com.ultra.megamod.lib.accessories.owo.ui.renderstate.GradientQuadElementRenderState;
import com.ultra.megamod.lib.accessories.owo.ui.renderstate.LineElementRenderState;
import com.ultra.megamod.lib.accessories.owo.ui.renderstate.RingElementRenderState;
...
public class OwoUIGraphics extends GuiGraphics {
    ...
    public static OwoUIGraphics of(GuiGraphics graphics) {
        var owoContext = new OwoUIGraphics(
            ...
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) graphics).owo$getGuiRenderState(),
    ...
    public boolean intersectsScissor(PositionedRectangle other) {
        other = other.transform(this.pose());

        var rect = ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getScissorStack().peek();
    ...
    public void drawGradientRect(RenderPipeline pipeline, int x, int y, int width, int height, int topLeftColor, int topRightColor, int bottomRightColor, int bottomLeftColor) {
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getGuiRenderState().submitGuiElement(new GradientQuadElementRenderState(
            pipeline,
            new Matrix3x2f(this.pose()),
            new ScreenRectangle(new ScreenPosition(x, y), width, height),
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getScissorStack().peek(),
    ...
    public void drawLine(RenderPipeline pipeline, int x1, int y1, int x2, int y2, double thiccness, Color color) {
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getGuiRenderState().submitGuiElement(new LineElementRenderState(
            pipeline,
            new Matrix3x2f(this.pose()),
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getScissorStack().peek(),
            x1, y1, x2, y2,
    ...
    public void drawCircle(RenderPipeline pipeline, int centerX, int centerY, double angleFrom, double angleTo, int segments, double radius, Color color) {
        ...
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getGuiRenderState().submitGuiElement(new CircleElementRenderState(
            pipeline,
            new Matrix3x2f(this.pose()),
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getScissorStack().peek(),
    ...
    public void drawRing(RenderPipeline pipeline, int centerX, int centerY, double angleFrom, double angleTo, int segments, double innerRadius, double outerRadius, Color innerColor, Color outerColor) {
        ...
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getGuiRenderState().submitGuiElement(new RingElementRenderState(
            pipeline,
            new Matrix3x2f(this.pose()),
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$getScissorStack().peek(),
    ...
    public void drawTooltip(Font textRenderer, int x, int y, List<ClientTooltipComponent> components, @Nullable Identifier texture) {
        ...
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) this).owo$setTooltipForNextFrameInternal(textRenderer, components, x, y, positioner, texture, focused);
