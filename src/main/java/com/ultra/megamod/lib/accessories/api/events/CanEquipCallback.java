...
///
/// @deprecated Use [com.ultra.megamod.lib.accessories.api.events.v2.CanEquipCallback] instead!
...
public interface CanEquipCallback {
    ...
    Event<CanEquipCallback> EVENT = new WrappedEvent<>(
        com.ultra.megamod.lib.accessories.api.events.v2.CanEquipCallback.EVENT,
