...
import com.ultra.megamod.mixin.accessories.owo.ui.access.EntityRendererAccessor;
...
import com.ultra.megamod.lib.accessories.owo.ui.renderstate.EntityElementRenderState;
...
public class EntityComponent<E extends Entity> extends BaseUIComponent {
    ...
    public void draw(OwoUIGraphics graphics, int mouseX, int mouseY, float partialTicks, float delta) {
        ...
        ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) graphics).owo$getGuiRenderState().submitPicturesInPictureState(new EntityElementRenderState(
            entityState,
            matrix,
            new ScreenRectangle(this.x, this.y, this.width, this.height),
            ((com.ultra.megamod.mixin.accessories.owo.ui.access.GuiGraphicsAccessor) (Object) graphics).owo$getScissorStack().peek()
        ));
    }
