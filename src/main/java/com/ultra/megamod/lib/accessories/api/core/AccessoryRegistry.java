...
import com.ultra.megamod.lib.accessories.api.events.v2.CanEquipCallback;
import com.ultra.megamod.lib.accessories.api.events.v2.CanUnequipCallback;
...
public class AccessoryRegistry {
    ...
    public static Accessory getAccessoryOrDefault(ItemStack stack){
        ...
        if(accessory == null) {
            accessory = stack.has(AccessoriesDataComponents.NESTED_ACCESSORIES.get()) ? DEFAULT_NEST : DEFAULT;
        }
