...
import com.ultra.megamod.mixin.accessories.owo.ui.SlotAccessor;
import com.ultra.megamod.lib.accessories.owo.ui.core.*;
import com.ultra.megamod.lib.accessories.owo.ui.inject.GreedyInputUIComponent;
import com.ultra.megamod.lib.accessories.owo.ui.util.DisposableScreen;
import com.ultra.megamod.lib.accessories.owo.ui.util.UIErrorToast;
...
public abstract class BaseOwoContainerScreen<R extends ParentUIComponent, S extends AbstractContainerMenu> extends AbstractContainerScreen<S> implements DisposableScreen {
    ...
    public void render(GuiGraphics vanillaContext, int mouseX, int mouseY, float delta) {
        ...
        if (!this.invalid) {
            ...
            this.drawComponentTooltip(context, mouseX, mouseY, delta);
        } else {
            this.onClose();
        }
    }
