...
import com.ultra.megamod.lib.spellengine.utils.WeaponCompatibility;
...
public class SpellAssignments {
    ...
    // - Fallback/auto assignments ??? - MAYBE Inject(TAIL) RegistryDataLoader.loadFromResource (probably wont be synced to clients)
