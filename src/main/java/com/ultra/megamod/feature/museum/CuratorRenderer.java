...
public class CuratorRenderer
extends AgeableMobRenderer<CuratorEntity, VillagerRenderState, VillagerModel> {
    ...
    public CuratorRenderer(EntityRendererProvider.Context ctx) {
    ...
    public void extractRenderState(CuratorEntity entity, VillagerRenderState renderState, float partialTick) {
