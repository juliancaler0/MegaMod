...
import com.ultra.megamod.feature.shouldersurfing.api.client.IShoulderSurfingCamera;
...
public class ShoulderSurfingCamera implements IShoulderSurfingCamera
{
	...
	private void init()
	{
		...
		// Guard: during mod config load the Minecraft client hasn't been constructed yet,
		// so getInstance() returns null and calling .getCameraEntity() on it NPEs. Fall
		// through to the "no camera entity" branch in that case.
	...
	@Override
	public double getCameraDistance() { return this.cameraDistance; }

	@Override
	public Vec3 getOffset() { return this.offset; }

	@Override
	public Vec3 getRenderOffset() { return this.renderOffset; }

	@Override
	public Vec3 getTargetOffset() { return this.targetOffset; }

	@Override
	public float getXRot() { return this.xRot + this.xRotOffset; }
	...
	@Override
	public float getYRot() { return this.yRot + this.yRotOffset; }
	...
	public float getFreeLookYRot() { return this.freeLookYRot; }

	public void setLastMovedYRot(float lastMovedYRot) { this.lastMovedYRot = lastMovedYRot; }
