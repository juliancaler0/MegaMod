...
import com.ultra.megamod.feature.shouldersurfing.api.client.ICrosshairRenderer;
...
{
	private static final Identifier OBSTRUCTION_INDICATOR_SPRITE = Identifier.fromNamespaceAndPath("megamod", "hud/" + MOD_ID + "_obstruction_indicator");
	private static final Identifier OBSTRUCTED_CROSSHAIR_SPRITE = Identifier.fromNamespaceAndPath("megamod", "hud/" + MOD_ID + "_obstructed_crosshair");
	private static final Identifier OBSTRUCTED_CROSSHAIR_CROSS_SPRITE = Identifier.fromNamespaceAndPath("megamod", "hud/" + MOD_ID + "_obstructed_crosshair_cross");
	...
	private void renderCustomCrosshair(GuiGraphics guiGraphics, Identifier sprite)
	{
		Minecraft minecraft = Minecraft.getInstance();

		if(minecraft.gameMode == null || minecraft.gameMode.getPlayerMode() != GameType.SPECTATOR)
		{
			guiGraphics.blitSprite(RenderPipelines.GUI_TEXTURED, sprite, (guiGraphics.guiWidth() - 15) / 2, (guiGraphics.guiHeight() - 15) / 2, 15, 15);
		}
	}
