...
import com.ultra.megamod.mixin.shouldersurfing.ClientInputAccessor;
...
{
	public static final KeyMapping.Category GENERAL = new KeyMapping.Category(Identifier.fromNamespaceAndPath("megamod", MOD_ID));
	...
	public static final KeyMapping ENTER_SHOULDER_SURFING = createKeyMapping("enter_shoulder_surfing", GLFW.GLFW_KEY_F6);
	...
	public static final KeyMapping[] ALL = {
		...
		FREE_LOOK, TOGGLE_CAMERA_COUPLING,
		TOGGLE_X_OFFSET_PRESETS, TOGGLE_Y_OFFSET_PRESETS, TOGGLE_Z_OFFSET_PRESETS,
		ENTER_FIRST_PERSON, ENTER_THIRD_PERSON_FRONT, ENTER_THIRD_PERSON_BACK, ENTER_SHOULDER_SURFING
	};
	...
	public void updateMovementInput(ClientInput input)
	{
		...
		{
			moveVector = moveVector.rotateDegrees(Mth.degreesDifference(cameraEntity.getYRot(), this.instance.getCamera().getFreeLookYRot()));
			((ClientInputAccessor) input).shouldersurfing$setMoveVector(moveVector.toVec2());
		}
