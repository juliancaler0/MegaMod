package com.ultra.megamod.feature.shouldersurfing.config;

import com.ultra.megamod.feature.shouldersurfing.api.client.IClientConfig;
import com.ultra.megamod.feature.shouldersurfing.api.model.CameraDistanceAttributeMode;
import com.ultra.megamod.feature.shouldersurfing.api.model.CrosshairType;
import com.ultra.megamod.feature.shouldersurfing.api.model.CrosshairVisibility;
import com.ultra.megamod.feature.shouldersurfing.api.model.Perspective;
import com.ultra.megamod.feature.shouldersurfing.api.model.PickOrigin;
import com.ultra.megamod.feature.shouldersurfing.api.model.PickVector;
import com.ultra.megamod.feature.shouldersurfing.api.model.TurningMode;
import com.ultra.megamod.feature.shouldersurfing.api.model.ViewBobbingMode;
...
import static com.ultra.megamod.feature.shouldersurfing.ShoulderSurfingFeature.MOD_ID;
	...
	public static class ClientConfig implements IClientConfig
	{
		...
		public ClientConfig(ModConfigSpec.Builder builder)
		{
			...
			this.adaptiveCrosshairHoldItemDefaultComponents = builder
				...
				.defineList("adaptive_crosshair_item_hold_default_components", ArrayList::new, String::new, ClientConfig::isValidDataComponentId);
		...
		@Override
		public double getOffsetX() { return this.offsetX.get(); }
		@Override
		public double getOffsetY() { return this.offsetY.get(); }
		@Override
		public double getOffsetZ() { return this.offsetZ.get(); }
		@Override
		public List<Double> getOffsetXPresets() { return this.offsetXPresets.get().stream().map(Double::parseDouble).toList(); }
		@Override
		public List<Double> getOffsetYPresets() { return this.offsetYPresets.get().stream().map(Double::parseDouble).toList(); }
		@Override
		public List<Double> getOffsetZPresets() { return this.offsetZPresets.get().stream().map(Double::parseDouble).toList(); }
		@Override
		public double getMinOffsetX() { return this.minOffsetX.get(); }
		@Override
		public double getMinOffsetY() { return this.minOffsetY.get(); }
		@Override
		public double getMinOffsetZ() { return this.minOffsetZ.get(); }
		@Override
		public double getMaxOffsetX() { return this.maxOffsetX.get(); }
		@Override
		public double getMaxOffsetY() { return this.maxOffsetY.get(); }
		@Override
		public double getMaxOffsetZ() { return this.maxOffsetZ.get(); }
		@Override
		public boolean isUnlimitedOffsetX() { return this.unlimitedOffsetX.get(); }
		@Override
		public boolean isUnlimitedOffsetY() { return this.unlimitedOffsetY.get(); }
		@Override
		public boolean isUnlimitedOffsetZ() { return this.unlimitedOffsetZ.get(); }
		@Override
		public double getPassengerOffsetXMultiplier() { return this.passengerOffsetXMultiplier.get(); }
		@Override
		public double getPassengerOffsetYMultiplier() { return this.passengerOffsetYMultiplier.get(); }
		@Override
		public double getPassengerOffsetZMultiplier() { return this.passengerOffsetZMultiplier.get(); }
		@Override
		public double getSprintOffsetXMultiplier() { return this.sprintOffsetXMultiplier.get(); }
		@Override
		public double getSprintOffsetYMultiplier() { return this.sprintOffsetYMultiplier.get(); }
		@Override
		public double getSprintOffsetZMultiplier() { return this.sprintOffsetZMultiplier.get(); }
		@Override
		public double getAimingOffsetXMultiplier() { return this.aimingOffsetXMultiplier.get(); }
		@Override
		public double getAimingOffsetYMultiplier() { return this.aimingOffsetYMultiplier.get(); }
		@Override
		public double getAimingOffsetZMultiplier() { return this.aimingOffsetZMultiplier.get(); }
		@Override
		public double getFallFlyingOffsetXMultiplier() { return this.fallFlyingOffsetXMultiplier.get(); }
		@Override
		public double getFallFlyingOffsetYMultiplier() { return this.fallFlyingOffsetYMultiplier.get(); }
		@Override
		public double getFallFlyingOffsetZMultiplier() { return this.fallFlyingOffsetZMultiplier.get(); }
		@Override
		public double getClimbingOffsetXMultiplier() { return this.climbingOffsetXMultiplier.get(); }
		@Override
		public double getClimbingOffsetYMultiplier() { return this.climbingOffsetYMultiplier.get(); }
		@Override
		public double getClimbingOffsetZMultiplier() { return this.climbingOffsetZMultiplier.get(); }
		@Override
		public double getPassengerOffsetXModifier() { return this.passengerOffsetXModifier.get(); }
		@Override
		public double getPassengerOffsetYModifier() { return this.passengerOffsetYModifier.get(); }
		@Override
		public double getPassengerOffsetZModifier() { return this.passengerOffsetZModifier.get(); }
		@Override
		public double getSprintOffsetXModifier() { return this.sprintOffsetXModifier.get(); }
		@Override
		public double getSprintOffsetYModifier() { return this.sprintOffsetYModifier.get(); }
		@Override
		public double getSprintOffsetZModifier() { return this.sprintOffsetZModifier.get(); }
		@Override
		public double getAimingOffsetXModifier() { return this.aimingOffsetXModifier.get(); }
		@Override
		public double getAimingOffsetYModifier() { return this.aimingOffsetYModifier.get(); }
		@Override
		public double getAimingOffsetZModifier() { return this.aimingOffsetZModifier.get(); }
		@Override
		public double getFallFlyingOffsetXModifier() { return this.fallFlyingOffsetXModifier.get(); }
		@Override
		public double getFallFlyingOffsetYModifier() { return this.fallFlyingOffsetYModifier.get(); }
		@Override
		public double getFallFlyingOffsetZModifier() { return this.fallFlyingOffsetZModifier.get(); }
		@Override
		public double getClimbingOffsetXModifier() { return this.climbingOffsetXModifier.get(); }
		@Override
		public double getClimbingOffsetYModifier() { return this.climbingOffsetYModifier.get(); }
		@Override
		public double getClimbingOffsetZModifier() { return this.climbingOffsetZModifier.get(); }
		@Override
		public CameraDistanceAttributeMode getCameraDistanceAttributeMode() { return this.cameraDistanceAttributeMode.get(); }
		@Override
		public CrosshairVisibility getCrosshairVisibility(Perspective perspective) { return this.crosshairVisibility.get(perspective).get(); }
		@Override
		public boolean useCustomRaytraceDistance() { return this.useCustomRaytraceDistance.get(); }
		@Override
		public double keepCameraOutOfHeadMultiplier() { return this.keepCameraOutOfHeadMultiplier.get(); }
		@Override
		public boolean replaceDefaultPerspective() { return this.replaceDefaultPerspective.get(); }
		@Override
		public boolean isFirstPersonEnabled() { return this.isFirstPersonEnabled.get(); }
		@Override
		public boolean isThirdPersonFrontEnabled() { return this.isThirdPersonFrontEnabled.get(); }
		@Override
		public boolean isThirdPersonBackEnabled() { return this.isThirdPersonBackEnabled.get(); }
		@Override
		public Perspective getDefaultPerspective() { return this.defaultPerspective.get(); }
		public void setDefaultPerspective(Perspective perspective) { this.set(this.defaultPerspective, perspective); }
		@Override
		public CrosshairType getCrosshairType() { return this.crosshairType.get(); }
		@Override
		public boolean doRememberLastPerspective() { return this.rememberLastPerspective.get(); }
		@Override
		public double getCameraStepSize() { return this.cameraStepSize.get(); }
		@Override
		public double getCameraTransitionSpeedMultiplier() { return this.cameraTransitionSpeedMultiplier.get(); }
		@Override
		public double getCenterCameraWhenLookingDownAngle() { return this.centerCameraWhenLookingDownAngle.get(); }
		@Override
		public double getHidePlayerWhenLookingUpAngle() { return this.hidePlayerWhenLookingUpAngle.get(); }
		@Override
		public boolean doDynamicallyAdjustOffsets() { return this.dynamicallyAdjustOffsets.get(); }
		@Override
		public boolean isPlayerTransparencyEnabled() { return Config.CLIENT_SPEC.isLoaded() ? this.playerTransparency.get() : this.playerTransparency.getDefault(); }
		@Override
		public boolean turnPlayerTransparentWhenAiming() { return this.turnPlayerTransparentWhenAiming.get(); }
		@Override
		public TurningMode getTurningModeWhenUsingItem() { return this.turningModeWhenUsingItem.get(); }
		@Override
		public TurningMode getTurningModeWhenAttacking() { return this.turningModeWhenAttacking.get(); }
		@Override
		public TurningMode getTurningModeWhenInteracting() { return this.turningModeWhenInteraction.get(); }
		@Override
		public TurningMode getTurningModeWhenPicking() { return this.turningModeWhenPicking.get(); }
		@Override
		public int getTurningLockTime() { return this.turningLockTime.get(); }
		@Override
		public double getTurningSpeedMultiplier() { return this.turningSpeedMultiplier.get(); }
		@Override
		public PickOrigin getEntityPickOrigin() { return this.entityPickOrigin.get(); }
		@Override
		public PickOrigin getBlockPickOrigin() { return this.blockPickOrigin.get(); }
		@Override
		public PickVector getPickVector() { return this.pickVector.get(); }
		@Override
		public boolean isCameraDecoupled() { return this.isCameraDecoupled.get(); }
		@Override
		public boolean doOrientCameraOnTeleport() { return this.orientCameraOnTeleport.get(); }
		@Override
		public boolean isFovOverrideEnabled() { return this.isFovOverrideEnabled.get(); }
		@Override
		public float getFovOverride() { return this.fovOverride.get().floatValue(); }
		@Override
		public ViewBobbingMode getViewBobbingMode() { return this.viewBobbingMode.get(); }
		@Override
		public boolean getFollowPlayerRotations() { return this.followPlayerRotations.get(); }
		@Override
		public int getFollowPlayerRotationsDelay() { return this.followPlayerRotationsDelay.get(); }
		@Override
		public double getCameraDragXMultiplier() { return this.cameraDragXMultiplier.get(); }
		@Override
		public double getCameraDragYMultiplier() { return this.cameraDragYMultiplier.get(); }
		@Override
		public double getCameraDragZMultiplier() { return this.cameraDragZMultiplier.get(); }
		@Override
		public double getCameraSwayXMaxAngle() { return this.cameraSwayXMaxAngle.get(); }
		@Override
		public double getCameraSwayZMaxAngle() { return this.cameraSwayZMaxAngle.get(); }
		@Override
		public double getCameraSwayXMaxVelocity() { return this.cameraSwayXMaxVelocity.get(); }
		@Override
		public double getCameraSwayZMaxVelocity() { return this.cameraSwayZMaxVelocity.get(); }
		@Override
		public double getCustomRaytraceDistance() { return this.customRaytraceDistance.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairHoldItems() { return this.adaptiveCrosshairHoldItems.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairUseItems() { return this.adaptiveCrosshairUseItems.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairHoldItemAnimations() { return this.adaptiveCrosshairHoldItemAnimations.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairUseItemAnimations() { return this.adaptiveCrosshairUseItemAnimations.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairHoldItemDefaultComponents() { return this.adaptiveCrosshairHoldItemDefaultComponents.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairUseItemDefaultComponents() { return this.adaptiveCrosshairUseItemDefaultComponents.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairHoldItemComponents() { return this.adaptiveCrosshairHoldItemComponents.get(); }
		@Override
		public List<? extends String> getAdaptiveCrosshairUseItemComponents() { return this.adaptiveCrosshairUseItemComponents.get(); }
		@Override
		public boolean getShowObstructionCrosshair() { return this.showObstructionIndicator.get(); }
		@Override
		public boolean showObstructionIndicatorWhenAiming() { return this.showObstructionIndicatorWhenAiming.get(); }
		@Override
		public double getObstructionIndicatorMaxDistanceToObstruction() { return this.obstructionIndicatorMaxDistanceToObstruction.get(); }
		@Override
		public int getObstructionIndicatorMinDistanceToCrosshair() { return this.obstructionIndicatorMinDistanceToCrosshair.get(); }
		@Override
		public boolean doCenterPlayerSounds() { return this.centerPlayerSounds.get(); }
		@Override
		public boolean shouldPlayerXRotFollowCamera() { return this.playerXRotFollowsCamera.get(); }
		@Override
		public boolean shouldPlayerYRotFollowCamera() { return this.playerYRotFollowsCamera.get(); }
		@Override
		public double getPlayerYRotFollowAngleLimit() { return this.playerYRotFollowAngleLimit.get(); }
		...
		public void toggleOffsetXPreset() { this.toggleOffsetPreset(this.offsetX, this.getOffsetXPresets()); }
		public void toggleOffsetYPreset() { this.toggleOffsetPreset(this.offsetY, this.getOffsetYPresets()); }
		public void toggleOffsetZPreset() { this.toggleOffsetPreset(this.offsetZ, this.getOffsetZPresets()); }
