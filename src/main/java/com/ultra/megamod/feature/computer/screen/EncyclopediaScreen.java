...
public class EncyclopediaScreen extends Screen {
    ...
    private void buildWeaponEntries() {
        ...
        // Legendary "tome" wiki entries removed — those items were asset-only with no Java
        // registration, so the entries pointed at air. Tomes: vampiric_tome, static_seeker,
        // battledancer, ebonchill, lightbinder, crescent_blade, ghost_fang, terra_warhammer,
        // voidreaver, solaris, stormfury, briarthorn, abyssal_trident, pyroclast, whisperwind,
        // soulchain, soka_singing_blade.
