...
public class EncyclopediaScreen extends Screen {
    ...
    private void buildWeaponEntries() {
        ...
        allEntries.add(new WikiEntry("weapon_unique_dagger_3", "Whispersting", "Relics", List.of(
            ...
            "",
            "##Spell 1: Nerve Strike",
            "  - Hit a pressure point to stun the target",
            "    briefly",
            "  - Cooldown: 3 seconds",
            "",
            "##Spell 2: Fan of Knives",
        ...
        allEntries.add(new WikiEntry("weapon_unique_spear_sw", "Mounting Vengeance", "Relics", List.of(
            ...
            "",
            "##Spell 1: Vengeance Leech",
            "  - Thrust to drain the target's life force,",
            "    healing yourself for the damage dealt",
            "  - Cooldown: 5 seconds",
            "",
            "##Spell 2: Mounting Strike",
    ...
    private void buildReliquaryEntries() {
        // ---- OVERVIEW ----
        allEntries.add(new WikiEntry("reliquary_overview", "Reliquary Overview", "Reliquary", List.of(
            "##Magical Relics from Reliquary",
            "",
            "Reliquary is a classic magic/utility mod now ported",
            "directly into MegaMod. It adds a wide range of",
            "powerful relics, a custom handgun with specialty",
            "ammo, apothecary-style potion brewing, alkahestry",
            "duplication, pedestal automation, and mob charms.",
            "",
            "##Categories",
            "  - Relics: 30+ unique tools and artifacts",
            "  - Handgun + Ammo: 9 bullet types, 9 magazines",
            "  - Apothecary: Mortar + Cauldron brewing",
            "  - Alkahestry: Tome-based item duplication",
            "  - Pedestals: Automation-ready display blocks",
            "  - Mob Charms: Make specific mobs ignore you",
            "",
            "##Note on MegaMod Alchemy",
            "MegaMod's previous alchemy system (Alchemy Cauldron",
            "and Grindstone) has been removed. Reliquary's",
            "Apothecary Mortar + Cauldron fully replace it."
        )));

        // ---- RELIC ITEMS (31) ----
        allEntries.add(new WikiEntry("reliquary_hero_medallion", "Hero's Medallion", "Reliquary Items", List.of(
            "##Hero's Medallion",
            "",
            "Stores experience for you. While active, it absorbs",
            "XP from the player. While inactive, right-click to",
            "reclaim one level per click.",
            "",
            "##Activation",
            "  - Shift + Right-click to toggle absorb mode",
            "  - Right-click to drain levels back to you",
            "  - Shift + Scroll to change drain / fill amount",
            "",
            "##Usage",
            "  - Tooltip shows levels stored plus leftover XP",
            "  - Can be placed in a Pedestal to become an XP tank",
            "    that also repairs nearby Mending items"
        )));
        allEntries.add(new WikiEntry("reliquary_twilight_cloak", "Twilight Cloak", "Reliquary Items", List.of(
            "##Twilight Cloak",
            "",
            "Makes you invisible in darkness. As long as you",
            "are in a low-light area with the cloak in your",
            "inventory, mobs cannot target you, even if you",
            "attack them.",
            "",
            "##Activation",
            "  - Shift + Right-click to turn the cloak on",
            "  - Works passively once enabled and in dim light",
            "",
            "##Usage",
            "  - Great for sneaking through caves or bases",
            "  - Effect breaks immediately in bright light"
        )));
        allEntries.add(new WikiEntry("reliquary_fortune_coin", "Coin of Fortune", "Reliquary Items", List.of(
            "##Coin of Fortune",
            "",
            "Draws in nearby items and experience orbs to the",
            "player within roughly a 5-block radius.",
            "",
            "##Activation",
            "  - Shift + Right-click to toggle on/off",
            "  - Hold Right-click to super-vacuum (~15 blocks)",
            "",
            "##Usage",
            "  - Keybind: Enable/Disable Fortune Coin",
            "  - In a Pedestal it pulls items and XP into",
            "    adjacent containers when active",
            "  - While disabled in a Pedestal it blocks other",
            "    fortune coins from picking up items in range"
        )));
        allEntries.add(new WikiEntry("reliquary_lantern_of_paranoia", "Lantern of Paranoia", "Reliquary Items", List.of(
            "##Lantern of Paranoia",
            "",
            "Automatically places torches in any unlit area",
            "around you that is considered unsafe.",
            "",
            "##Activation",
            "  - Shift + Right-click to activate",
            "",
            "##Usage",
            "  - Pulls torches from your inventory",
            "  - If you also carry a Sojourner's Staff, the",
            "    Lantern draws from the Staff's torch stockpile",
            "    first, so one stack lasts a long time"
        )));
        allEntries.add(new WikiEntry("reliquary_kraken_shell", "Kraken Shell", "Reliquary Items", List.of(
            "##Kraken Shell",
            "",
            "Absorbs drowning damage in exchange for hunger.",
            "Prevents you from drowning as long as you have",
            "food in the bar.",
            "",
            "##Activation",
            "  - Purely passive: keep it in your inventory",
            "",
            "##Usage",
            "  - Useful for underwater exploration, ocean",
            "    monuments and deep sea dungeons",
            "  - Does not protect against suffocation in blocks"
        )));
        allEntries.add(new WikiEntry("reliquary_phoenix_down", "Phoenix Down", "Reliquary Items", List.of(
            "##Phoenix Down",
            "",
            "Resurrects you once with full health and a variety",
            "of buffs, then reverts to an Angelic Feather.",
            "",
            "##Activation",
            "  - Automatic on lethal damage while in inventory",
            "",
            "##Usage",
            "  - One-shot revive similar to a Totem of Undying",
            "  - After use, it becomes an Angelic Feather and",
            "    keeps the feather's fall-damage protection",
            "  - Craft a fresh Phoenix Down to re-arm the revive"
        )));
        allEntries.add(new WikiEntry("reliquary_salamander_eye", "Salamander's Eye", "Reliquary Items", List.of(
            "##Salamander's Eye",
            "",
            "Dispels Blaze fireballs and reflects Ghast fireballs",
            "while held. Puts out fires on and around you.",
            "",
            "##Activation",
            "  - Purely passive while held in hand",
            "",
            "##Usage",
            "  - Point at a Ghast to bounce its fireball back",
            "  - Blaze fireballs are automatically doused",
            "  - Great for Nether exploration and Blaze farms"
        )));
        allEntries.add(new WikiEntry("reliquary_rending_gale", "Rending Gale", "Reliquary Items", List.of(
            "##Rending Gale",
            "",
            "Lets the player fly, push or pull mobs, or shoot",
            "lightning during a thunderstorm.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb feathers",
            "  - Right-click to use current mode",
            "  - Shift + Scroll to cycle modes",
            "",
            "##Usage",
            "  - Charged with feathers (shown in tooltip)",
            "  - Flight mode: point where you want to fly",
            "  - Push / Pull mode: shove or yank entities",
            "  - Bolt mode: call lightning where you aim",
            "    (only during thunderstorms)"
        )));
        allEntries.add(new WikiEntry("reliquary_serpent_staff", "Serpent Staff", "Reliquary Items", List.of(
            "##Serpent Staff",
            "",
            "Spews rapid-fire poison globs at your foes. Hit",
            "mobs are debuffed and rendered passive for 15s.",
            "",
            "##Activation",
            "  - Right-click to fire poison globs",
            "",
            "##Usage",
            "  - Drains life from targets on strike",
            "  - Useful for soloing mob groups: the first hit",
            "    pacifies a target while you focus others"
        )));
        allEntries.add(new WikiEntry("reliquary_ice_magus_rod", "Ice Magus Rod", "Reliquary Items", List.of(
            "##Ice Magus Rod",
            "",
            "Lobs harmful snowballs that deal real damage.",
            "Especially strong against fire-immune Nether mobs.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb snowballs",
            "  - Right-click to throw a damaging snowball",
            "",
            "##Usage",
            "  - Tooltip shows remaining snowball charge",
            "  - Hits Blazes, Magma Cubes and Ghasts hard",
            "  - Entry-tier rod: upgrade to Glacial Staff later"
        )));
        allEntries.add(new WikiEntry("reliquary_glacial_staff", "Glacial Staff", "Reliquary Items", List.of(
            "##Glacial Staff",
            "",
            "Upgraded Ice Magus Rod. Shoots snowballs, chills",
            "enemies on strike, and freezes the ground beneath",
            "your feet.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb snowballs",
            "  - Right-click to fire damaging snowballs",
            "",
            "##Usage",
            "  - Water around you turns to Packed Ice",
            "  - Lava turns to Obsidian while in range",
            "  - Blocks melt back once you walk away",
            "  - Perfect for crossing oceans or lava lakes"
        )));
        allEntries.add(new WikiEntry("reliquary_pyromancer_staff", "Pyromancer's Staff", "Reliquary Items", List.of(
            "##Pyromancer's Staff",
            "",
            "Shoots blaze and ghast fireballs, creates",
            "firebursts, and acts as a flint and steel.",
            "",
            "##Activation",
            "  - Shift + Scroll to change modes",
            "  - Right-click to fire current mode",
            "  - Charges with Blaze Powder and Fire Charges",
            "",
            "##Usage",
            "  - Protects the wielder from incoming fireballs",
            "  - Turning it off extinguishes nearby fires",
            "  - Tooltip shows charge count and blaze charge"
        )));
        allEntries.add(new WikiEntry("reliquary_sojourner_staff", "Sojourner's Staff", "Reliquary Items", List.of(
            "##Sojourner's Staff",
            "",
            "Holds up to 1500 torches and places them at long",
            "range. Every 6 blocks of distance adds one torch",
            "to the cost of the placement.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb torches",
            "  - Right-click a block to place at range",
            "  - Shift + Scroll to change placing block",
            "",
            "##Usage",
            "  - Max range: 30 blocks (costs 6 torches there)",
            "  - Pairs perfectly with the Lantern of Paranoia"
        )));
        allEntries.add(new WikiEntry("reliquary_ender_staff", "Ender Staff", "Reliquary Items", List.of(
            "##Ender Staff",
            "",
            "Consumes ender pearls to teleport you around.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb Ender Pearls",
            "  - Right-click to teleport in current mode",
            "  - Shift + Scroll to cycle modes",
            "",
            "##Modes",
            "  - Cast: thrown pearl (but pearls don't hurt you)",
            "  - Long Cast: pearl with reduced gravity, flies",
            "    much further",
            "  - Node Warp: hold right-click to teleport to the",
            "    Wraith Node you bound the staff to",
            "  - Bind: right-click a Wraith Node to bind"
        )));
        allEntries.add(new WikiEntry("reliquary_destruction_catalyst", "Destruction Catalyst", "Reliquary Items", List.of(
            "##Destruction Catalyst",
            "",
            "Consumes gunpowder to destroy mundane blocks in",
            "an area. Blocks destroyed this way drop nothing.",
            "",
            "##Activation",
            "  - Right-click a block to trigger the blast",
            "",
            "##Usage",
            "  - Leaves ores, chests and valuables in place",
            "  - Charge (gunpowder used) shown in tooltip",
            "  - Fast way to clear stone, dirt, gravel during",
            "    tunnel work or foundation flattening"
        )));
        allEntries.add(new WikiEntry("reliquary_infernal_claws", "Infernal Claws", "Reliquary Items", List.of(
            "##Infernal Claws",
            "",
            "Absorbs fire damage at the expense of hunger.",
            "Does not absorb lava damage (use Infernal Chalice",
            "for that).",
            "",
            "##Activation",
            "  - Purely passive while in inventory",
            "",
            "##Usage",
            "  - Very useful for Nether exploration",
            "  - As long as food is above zero, burning damage",
            "    is converted to hunger cost"
        )));
        allEntries.add(new WikiEntry("reliquary_magicbane", "Magicbane", "Reliquary Items", List.of(
            "##Magicbane",
            "",
            "Athame-style weapon. Small (16 durability) but",
            "grows stronger with every enchantment placed on",
            "it. Also has higher chance of Reliquary mob drops.",
            "",
            "##Activation",
            "  - Equip as main-hand and attack",
            "",
            "##Usage",
            "  - 50% chance on hit to inflict Confusion,",
            "    Blindness, Slowness, or Weakness",
            "  - Each enchantment level adds to base damage",
            "  - Counts as a gold item for Midas Touchstone",
            "    repair purposes"
        )));
        allEntries.add(new WikiEntry("reliquary_mercy_cross", "Cross of Mercy", "Reliquary Items", List.of(
            "##Cross of Mercy",
            "",
            "Holy sword that deals extra damage against",
            "undead creatures.",
            "",
            "##Activation",
            "  - Equip and attack undead targets",
            "",
            "##Usage",
            "  - Made of gold: enchants as a golden weapon",
            "  - Can be repaired with the Midas Touchstone",
            "  - Bonus damage stacks with Smite"
        )));
        allEntries.add(new WikiEntry("reliquary_shears_of_winter", "Shears of Winter", "Reliquary Items", List.of(
            "##Shears of Winter",
            "",
            "Magic shears that tear leaves from trees using",
            "cold and can shear an entire area at once.",
            "",
            "##Activation",
            "  - Left-click: shear one block like normal shears",
            "  - Hold Right-click: area-of-effect shearing",
            "",
            "##Usage",
            "  - AoE mode shears sheep around the player",
            "  - Also destroys leaves quickly in that mode",
            "  - Excellent for clearing tree canopies fast"
        )));
        allEntries.add(new WikiEntry("reliquary_witch_hat", "Witch Hat", "Reliquary Items", List.of(
            "##Witch Hat",
            "",
            "A pointy black hat dropped by witches.",
            "",
            "##Activation",
            "  - Wear in the head slot",
            "",
            "##Usage",
            "  - Required ingredient for the Tome of",
            "    Alkahestry recipe",
            "  - Looks like a leprechaun / witch costume",
            "    when worn"
        )));
        allEntries.add(new WikiEntry("reliquary_rod_of_lyssa", "Rod of Lyssa", "Reliquary Items", List.of(
            "##Rod of Lyssa",
            "",
            "A magic fishing rod that can reel in items and",
            "pick pockets.",
            "",
            "##Activation",
            "  - Right-click to cast like a fishing rod",
            "  - Sneak + Right-click an entity to steal",
            "",
            "##Usage",
            "  - Pulls entities much harder than a vanilla rod",
            "  - Pulls dropped items toward the player",
            "  - Pickpocket has a failure chance that scales",
            "    with target awareness"
        )));
        allEntries.add(new WikiEntry("reliquary_harvest_rod", "Harvest Rod", "Reliquary Items", List.of(
            "##Harvest Rod",
            "",
            "Farming helper tool that bonemeals, plants, and",
            "acts as an unbreakable hoe.",
            "",
            "##Activation",
            "  - Shift + Scroll to cycle modes",
            "  - Right-click single block to use on one target",
            "  - Hold Right-click for area-of-effect use",
            "",
            "##Modes",
            "  - Bonemeal: uses stored bonemeal to grow crops",
            "  - Plantable: plants held seed/crop in soil",
            "  - Hoe: unlimited durability hoe",
            "",
            "##Usage",
            "  - Auto-absorbs bonemeal and seeds from your",
            "    inventory when activated",
            "  - Works great inside a Pedestal for auto-farming"
        )));
        allEntries.add(new WikiEntry("reliquary_midas_touchstone", "Touchstone of Midas", "Reliquary Items", List.of(
            "##Touchstone of Midas",
            "",
            "Repairs gold items using stored glowstone charge.",
            "",
            "##Activation",
            "  - Shift + Right-click to absorb glowstone",
            "  - Right-click a gold item to repair it",
            "",
            "##Usage",
            "  - Also repairs Magicbane and Mercy Cross (both",
            "    count as gold for enchanting/repair)",
            "  - Charge value shown in tooltip"
        )));
        allEntries.add(new WikiEntry("reliquary_emperor_chalice", "Emperor's Chalice", "Reliquary Items", List.of(
            "##Emperor's Chalice",
            "",
            "An infinite water bucket that also doubles as",
            "food by trading hunger for health.",
            "",
            "##Activation",
            "  - Right-click a block face to place water",
            "  - Right-click while aiming at nothing to drink",
            "  - Shift + Right-click toggles drain/place mode",
            "",
            "##Usage",
            "  - Drain mode: pick up water sources",
            "  - Place mode: unlimited water source",
            "  - Drinking restores hunger at the cost of HP"
        )));
        allEntries.add(new WikiEntry("reliquary_infernal_chalice", "Infernal Chalice", "Reliquary Items", List.of(
            "##Infernal Chalice",
            "",
            "Stores lava and protects you from lava and fire",
            "damage in exchange for hunger.",
            "",
            "##Activation",
            "  - Shift + Right-click to toggle drain mode",
            "  - Right-click lava to absorb it (drain mode)",
            "  - Right-click a block to pour lava (place mode)",
            "",
            "##Usage",
            "  - Tooltip shows millibuckets stored",
            "  - Fire/lava damage to the holder is absorbed",
            "    while food is above zero"
        )));
        allEntries.add(new WikiEntry("reliquary_void_tear", "Void Tear", "Reliquary Items", List.of(
            "##Void Tear",
            "",
            "Holds a nearly-unlimited amount of a single item",
            "type and can act as a portable auto-vacuum or",
            "auto-refill.",
            "",
            "##Activation",
            "  - Right-click to capture what you hold most of",
            "  - Shift + Right-click to activate auto-absorb",
            "  - Shift + Scroll to change mode",
            "  - Right-click a chest to dump/fill that item",
            "",
            "##Modes",
            "  - EMPTY: no refill, takes stacks from inventory",
            "  - STACK: keeps one stack of that item on you",
            "  - FILL: refills your whole inventory with it"
        )));
        allEntries.add(new WikiEntry("reliquary_infernal_tear", "Infernal Tear", "Reliquary Items", List.of(
            "##Infernal Tear",
            "",
            "Burns items from your inventory into experience.",
            "",
            "##Activation",
            "  - Shift + Right-click to capture the item you",
            "    have the most of (must be on the whitelist)",
            "  - Right-click to remove the item association",
            "",
            "##Usage",
            "  - Any new item of that type that enters your",
            "    inventory is auto-converted to XP",
            "  - Whitelist matches Alkahestry Tome inputs"
        )));
        allEntries.add(new WikiEntry("reliquary_alkahestry_tome", "Tome of Alkahestry", "Reliquary Items", List.of(
            "##Tome of Alkahestry",
            "",
            "The centerpiece of the alkahestry system. Stores",
            "charge and uses it to duplicate certain items and",
            "blocks via crafting.",
            "",
            "##Activation",
            "  - Shift + Right-click to activate",
            "  - Right-click to read the in-game guide",
            "  - Place in a crafting grid with compatible items",
            "    to duplicate them",
            "",
            "##Usage",
            "  - While active, absorbs redstone and glowstone",
            "    from your inventory",
            "  - Right-click an Altar of Light to fuel it with",
            "    tome charge",
            "  - Tooltip shows current and max charge"
        )));
        allEntries.add(new WikiEntry("reliquary_witherless_rose", "Witherless Rose", "Reliquary Items", List.of(
            "##Witherless Rose",
            "",
            "A Nether Star-infused rose that protects its",
            "holder from Wither.",
            "",
            "##Activation",
            "  - Purely passive while in inventory",
            "",
            "##Usage",
            "  - Grants full immunity to the Wither effect",
            "  - Mandatory item for Wither boss fights",
            "  - Excellent for Wither Skeleton farms"
        )));
        allEntries.add(new WikiEntry("reliquary_angelic_feather", "Angelic Feather", "Reliquary Items", List.of(
            "##Angelic Feather",
            "",
            "Absorbs fall damage at the expense of hunger and",
            "grants a minor jump boost.",
            "",
            "##Activation",
            "  - Purely passive while in inventory",
            "",
            "##Usage",
            "  - Keep food above zero to stay protected",
            "  - Bonus jump height helps with parkour",
            "  - Used as a crafting component in Phoenix Down"
        )));
        allEntries.add(new WikiEntry("reliquary_holy_hand_grenade", "Holy Hand Grenade", "Reliquary Items", List.of(
            "##Holy Hand Grenade",
            "",
            "A powerful thrown explosive that only harms",
            "enemies. It does not damage blocks or the thrower.",
            "",
            "##Activation",
            "  - Right-click to throw",
            "",
            "##Usage",
            "  - Safe to use indoors: zero terrain damage",
            "  - Massive damage to mobs in the blast radius",
            "  - Classic Monty Python reference"
        )));
        allEntries.add(new WikiEntry("reliquary_angelheart_vial", "Angelheart Vial", "Reliquary Items", List.of(
            "##Angelheart Vial",
            "",
            "One-shot revive potion. Shatters on lethal damage,",
            "restoring a bit of health and buffing the player.",
            "",
            "##Activation",
            "  - Automatic on lethal damage while in inventory",
            "",
            "##Usage",
            "  - Similar idea to Totem of Undying but lighter",
            "  - Breaks after use (single resurrection)",
            "  - Cheaper than Phoenix Down but less potent"
        )));

        // ---- HANDGUN SYSTEM (5) ----
        allEntries.add(new WikiEntry("reliquary_handgun", "Hunter's Handgun", "Reliquary", List.of(
            "##Hunter's Handgun",
            "",
            "Ranged firearm with recoil, knockback, reload",
            "time, and fire-rate stats that scale with the",
            "player's level. Maxed stats at level 20.",
            "",
            "##Activation",
            "  - Right-click to fire",
            "  - Hold Right-click to reload a magazine",
            "",
            "##Usage",
            "  - Accepts all 9 loaded magazine types",
            "  - Fires the matching bullet kind",
            "  - Tooltip shows current ammo and count"
        )));
        allEntries.add(new WikiEntry("reliquary_magazines", "Handgun Magazines", "Reliquary", List.of(
            "##Handgun Magazines (10 variants)",
            "",
            "Each magazine holds one kind of bullet. Load a",
            "magazine into the Handgun to fire that ammo.",
            "",
            "##Variants",
            "  - Empty Magazine: reusable casing",
            "  - Neutral Magazine: basic shots",
            "  - Exorcism Magazine: crushes undead",
            "  - Blaze Magazine: pure fire damage + ignite",
            "  - Ender Magazine: piercing + homing",
            "  - Concussive Magazine: small explosion",
            "  - Buster Magazine: TNT-scale explosion",
            "  - Seeker Magazine: hard-locked homing shots",
            "  - Sand Magazine: blinds targets, pops creepers",
            "  - Storm Magazine: stronger in storms, charges",
            "    creepers"
        )));
        allEntries.add(new WikiEntry("reliquary_bullets", "Handgun Bullets", "Reliquary", List.of(
            "##Handgun Bullets",
            "",
            "Individual shots crafted into magazines.",
            "",
            "##Types",
            "  - Empty Casing: leftover after firing",
            "  - Neutral Shot: balanced damage, cheap",
            "  - Exorcism Shot: massive damage vs. undead",
            "  - Blaze Shot: fire-only, useless vs. fire mobs",
            "  - Ender Shot: chases + pierces multiple targets",
            "  - Concussive Shot: small area damage",
            "  - Buster Shot: big explosion (breaks terrain)",
            "  - Seeker Shot: hard homing, can't miss",
            "  - Sand Shot: Blindness + instant creeper pop,",
            "    weakened in rain",
            "  - Storm Shot: charges creepers, bonus in rain"
        )));
        allEntries.add(new WikiEntry("reliquary_handgun_reloading", "Handgun Reloading", "Reliquary", List.of(
            "##Reloading the Handgun",
            "",
            "Magazines are single-use and must be swapped in.",
            "",
            "##Procedure",
            "  1. Have a loaded magazine in your inventory",
            "  2. Hold Right-click with the handgun",
            "  3. The current magazine empties out",
            "  4. A full magazine of the same type is consumed",
            "",
            "##Tips",
            "  - Carry multiple magazine types for different",
            "    targets (e.g. Exorcism for Nether)",
            "  - Empty Magazines can be recrafted with new",
            "    bullets to save resources",
            "  - Spent Empty Casings drop after firing"
        )));
        allEntries.add(new WikiEntry("reliquary_handgun_admin", "Handgun Admin Notes", "Reliquary", List.of(
            "##Handgun Admin Notes",
            "",
            "Server operators can use the admin Toggles tab",
            "to disable the Handgun and its ammo if the",
            "server prefers a no-firearm feel.",
            "",
            "##Useful Settings",
            "  - Toggle the Handgun's damage multipliers",
            "  - Disable specific bullet types (e.g. Buster)",
            "  - Remove Handgun from creative tab via Toggles",
            "",
            "##See also",
            "  - Encyclopedia entry: 'Reliquary Toggles'"
        )));

        // ---- APOTHECARY SYSTEM (4) ----
        allEntries.add(new WikiEntry("reliquary_apothecary_cauldron", "Apothecary Cauldron", "Reliquary Blocks", List.of(
            "##Apothecary Cauldron",
            "",
            "Used to brew potions from potion essence. You",
            "need a lit fire underneath and water inside to",
            "start brewing, plus empty Condensed Potion Vials",
            "to collect the result.",
            "",
            "##Setup",
            "  1. Place cauldron over fire, lava or campfire",
            "  2. Right-click with water bucket to fill",
            "  3. Add Potion Essence + Nether Wart",
            "  4. Wait for brewing to finish",
            "  5. Right-click with an empty vial to extract",
            "",
            "##Notes",
            "  - Supports regular, Splash, and Lingering output",
            "  - Replaces MegaMod's removed Alchemy Cauldron"
        )));
        allEntries.add(new WikiEntry("reliquary_apothecary_mortar", "Apothecary Mortar", "Reliquary Blocks", List.of(
            "##Apothecary Mortar",
            "",
            "Grinds reagents into Potion Essence, which is",
            "then brewed in the Apothecary Cauldron.",
            "",
            "##How to Use",
            "  1. Right-click the Mortar to open its GUI",
            "  2. Add 2-3 ingredients (mob drops or essences)",
            "  3. Grind into a Potion Essence",
            "",
            "##Notes",
            "  - Ingredients share passive effects; when two",
            "    or more ingredients have the same passive",
            "    effect, it becomes an active effect on the",
            "    resulting essence",
            "  - Replaces MegaMod's removed Alchemy Grindstone"
        )));
        allEntries.add(new WikiEntry("reliquary_brewing_reagents", "Brewing Reagents", "Reliquary", List.of(
            "##Reliquary Brewing Reagents",
            "",
            "Mob drops used inside the Apothecary Mortar.",
            "",
            "##Drops",
            "  - Slime Pearl: from Slimes",
            "  - Catalyzing Gland: from Creepers and Ghasts",
            "  - Chelicerae: from Spiders (regular + cave)",
            "  - Rib Bone: from Skeletons",
            "  - Molten Core: from Blazes and Magma Cubes",
            "  - Bat Wing: from Bats",
            "  - Eye of the Storm: from Charged Creepers",
            "  - Frozen Core: from Snow Golems",
            "  - Nebulous Heart: from Endermen",
            "  - Fertile Essence: crafting component",
            "",
            "##Notes",
            "  - Additional drops exist (Zombie Heart, Squid",
            "    Beak, Withered Rib, Guardian Spike, etc.)",
            "  - Combine drops in the Mortar to make essences"
        )));
        allEntries.add(new WikiEntry("reliquary_custom_effects", "Reliquary Potion Effects", "Reliquary", List.of(
            "##Custom Mob Effects",
            "",
            "Reliquary adds a small number of custom effects",
            "that can be brewed through the Apothecary system.",
            "",
            "##Effects",
            "  - Cure: cures Zombie Villagers affected by it",
            "  - Flight: grants creative flight while active",
            "  - Pacification: on-hit effect used by Serpent",
            "    Staff to make mobs passive for 15 seconds",
            "",
            "##Notes",
            "  - Cure + Flight can appear on condensed potions",
            "    made in the Apothecary Cauldron",
            "  - Condensed potions support Splash and Lingering",
            "    forms, and can be used to craft Tipped Arrows"
        )));

        // ---- ALKAHESTRY (3) ----
        allEntries.add(new WikiEntry("reliquary_alkahestry_altar", "Altar of Light", "Reliquary Blocks", List.of(
            "##Altar of Light",
            "",
            "Converts redstone into glowstone over time.",
            "",
            "##How to Use",
            "  1. Place in direct sunlight",
            "  2. Right-click with redstone until it activates",
            "  3. Wait: a glowstone block spawns on top",
            "  4. Optionally convert it back to redstone using",
            "     the Tome of Alkahestry for profit",
            "",
            "##Notes",
            "  - Needs direct sky access to function",
            "  - The Tome of Alkahestry can fuel it directly"
        )));
        allEntries.add(new WikiEntry("reliquary_alkahestry_tome_usage", "Alkahestry Tome Usage", "Reliquary", List.of(
            "##Using the Tome of Alkahestry",
            "",
            "The tome has three main jobs: charging itself,",
            "crafting duplicates, and draining charge back out.",
            "",
            "##Charging",
            "  - Shift + Right-click to activate absorb mode",
            "  - Absorbs redstone and glowstone from inventory",
            "",
            "##Crafting",
            "  - Place the tome in a crafting grid alongside",
            "    a supported item or block",
            "  - The result is a duplicate for a charge cost",
            "",
            "##Draining",
            "  - Right-click an Altar of Light to pour charge",
            "    into the altar as fuel"
        )));
        allEntries.add(new WikiEntry("reliquary_alkahestry_recipes", "Alkahestry Recipes", "Reliquary", List.of(
            "##Alkahestry Recipe Overview",
            "",
            "The Tome of Alkahestry can duplicate a curated",
            "list of items and blocks.",
            "",
            "##Typical Targets",
            "  - Common drops like Bones, String, Flint",
            "  - Plant products like Wheat, Melon Slices",
            "  - Select ores and dusts (mod-defined whitelist)",
            "",
            "##Notes",
            "  - Each duplication costs tome charge",
            "  - The Infernal Tear's whitelist mirrors the",
            "    Tome's input list: if the Tome can craft",
            "    with it, the Infernal Tear can burn it",
            "  - JEI / Reliquary admin tab shows the full list"
        )));

        // ---- PEDESTALS (4) ----
        allEntries.add(new WikiEntry("reliquary_pedestals", "Pedestals Overview", "Reliquary Blocks", List.of(
            "##Pedestals",
            "",
            "A fancy way of displaying items that also",
            "supports simple automation. Items placed inside",
            "a pedestal gain behaviour based on their type.",
            "",
            "##Activation",
            "  - Right-click the pedestal's switch (empty hand)",
            "  - OR provide a redstone signal",
            "  - OR link another pedestal with a redstone block",
            "",
            "##Notes",
            "  - Pedestals pair well with the Harvest Rod,",
            "    Fortune Coin, Hero's Medallion, etc.",
            "  - Inactive pedestals fall back to display mode"
        )));
        allEntries.add(new WikiEntry("reliquary_passive_pedestal", "Passive Pedestal", "Reliquary Blocks", List.of(
            "##Passive Pedestal (Display only)",
            "",
            "A decorative version of the pedestal that only",
            "displays an item. No automation.",
            "",
            "##Usage",
            "  - Right-click with an item to place it",
            "  - Right-click empty-handed to retrieve",
            "",
            "##Notes",
            "  - Perfect for trophy rooms and museum builds",
            "  - Uses the same model space as regular pedestal"
        )));
        allEntries.add(new WikiEntry("reliquary_pedestal_wrappers", "Pedestal Wrappers", "Reliquary", List.of(
            "##Pedestal Item Wrappers",
            "",
            "Each supported item runs its own automation",
            "wrapper when placed inside an active pedestal.",
            "",
            "##Wrappers",
            "  - Bucket: milks cows, picks up fluids",
            "  - Fishing Rod: auto-fishes for the player",
            "  - Harvest Rod: bonemeals + plants in range",
            "  - Melee Weapon: attacks nearby hostile mobs",
            "    (ignores bosses, tamed, baby animals)",
            "  - Redstone: drives another pedestal remotely",
            "  - Rending Gale: pushes/pulls or throws bolts",
            "    from the pedestal position",
            "  - Shears: shears nearby blocks and entities",
            "",
            "##Notes",
            "  - Other items (Fortune Coin, Hero's Medallion)",
            "    have their own dedicated pedestal modes"
        )));
        allEntries.add(new WikiEntry("reliquary_using_pedestals", "Using Pedestals", "Reliquary", List.of(
            "##Using Pedestals in Practice",
            "",
            "Pedestals shine as cheap automation stations.",
            "",
            "##Tips",
            "  - Place adjacent containers to receive items",
            "  - Feed redstone signals to batch-start tasks",
            "  - Combine a Harvest Rod pedestal with a",
            "    Bucket pedestal for self-watering farms",
            "  - Use a Fortune Coin pedestal as a central",
            "    vacuum point at XP/mob farms",
            "  - Remote redstone mode lets one switch trigger",
            "    a whole array of pedestals"
        )));

        // ---- MOB CHARMS (3) ----
        allEntries.add(new WikiEntry("reliquary_mob_charm_belt", "Mob Charm Belt", "Reliquary Items", List.of(
            "##Mob Charm Belt",
            "",
            "Holds all of your Mob Charms. Charms inside the",
            "belt still function the same as when worn loose",
            "in the inventory.",
            "",
            "##Activation",
            "  - Right-click the belt to open its GUI",
            "  - Drag charms in and out of the grid",
            "",
            "##Usage",
            "  - Can be equipped in a belt slot (accessory)",
            "  - Drastically reduces hotbar clutter for",
            "    players who carry many charms at once"
        )));
        allEntries.add(new WikiEntry("reliquary_mob_charm_fragments", "Mob Charm Fragments", "Reliquary Items", List.of(
            "##Mob Charm Fragments",
            "",
            "Shards dropped by the matching mob species. Used",
            "to craft a full Mob Charm for that mob.",
            "",
            "##Usage",
            "  - Kill the matching mob to get fragments",
            "  - Combine fragments into a full charm (per",
            "    species recipe)",
            "",
            "##Notes",
            "  - Every vanilla hostile mob family has its own",
            "    fragment and charm",
            "  - Fragments also work as repair ingredients on",
            "    a damaged charm of the same species"
        )));
        allEntries.add(new WikiEntry("reliquary_mob_charm_crafting", "Mob Charm Crafting & Repair", "Reliquary", List.of(
            "##Crafting and Repairing Mob Charms",
            "",
            "A Mob Charm makes the matching mob type ignore",
            "the player, even after being attacked.",
            "",
            "##Crafting",
            "  - Collect enough fragments of a given mob",
            "  - Combine them to form a full charm",
            "",
            "##Repair",
            "  - A charm has durability that ticks down as it",
            "    deflects aggro",
            "  - Feed it more fragments of the same species",
            "    to restore durability",
            "",
            "##Storage",
            "  - Drop charms into the Mob Charm Belt to keep",
            "    them all active at once"
        )));

        // ---- OTHER BLOCKS (3) ----
        allEntries.add(new WikiEntry("reliquary_interdiction_torch", "Interdiction Torch", "Reliquary Blocks", List.of(
            "##Interdiction Torch",
            "",
            "Creates a wall of force that prevents entities",
            "from getting near it.",
            "",
            "##Usage",
            "  - Place like a torch on any face",
            "  - Repels mobs and projectiles in a radius",
            "",
            "##Notes",
            "  - Great for defending bases or safe rooms",
            "  - Does not drain experience or resources",
            "  - Stacks with multiple torches for wider zones"
        )));
        allEntries.add(new WikiEntry("reliquary_fertile_lily_pad", "Lilypad of Fertility", "Reliquary Blocks", List.of(
            "##Lilypad of Fertility",
            "",
            "Speeds up growth of nearby crops.",
            "",
            "##Usage",
            "  - Place on water near farmland",
            "  - Crops closer to the lilypad grow fastest",
            "  - Multiple lilypads stack for greater effect",
            "",
            "##Notes",
            "  - Classic Reliquary feature",
            "  - Combine with Harvest Rod in a Pedestal for a",
            "    fully automated crop farm"
        )));
        allEntries.add(new WikiEntry("reliquary_wraith_node", "Wraith Node", "Reliquary Blocks", List.of(
            "##Wraith Node",
            "",
            "A destination block used with the Ender Staff in",
            "Wraith Node mode.",
            "",
            "##How to Use",
            "  1. Place the Wraith Node where you want to warp",
            "  2. Right-click the node with the Ender Staff to",
            "     bind the staff to that location",
            "  3. Switch the staff to Wraith Node mode and",
            "     hold Right-click to teleport to the node",
            "",
            "##Notes",
            "  - Cross-dimensional warps are not supported",
            "  - Each node binding costs Ender Pearls per warp"
        )));

        // ---- INTEGRATION (3) ----
        allEntries.add(new WikiEntry("reliquary_toggles", "Reliquary Toggles", "Reliquary", List.of(
            "##Reliquary Feature Toggles",
            "",
            "Reliquary features can be enabled or disabled",
            "server-wide from the admin panel's Toggles tab.",
            "",
            "##Where",
            "  - Open the Computer (or phone)",
            "  - Go to Admin > Toggles",
            "  - Select the Reliquary category",
            "",
            "##Examples",
            "  - Disable the Handgun entirely",
            "  - Switch off specific relics (e.g. Ender Staff)",
            "  - Turn off the Alkahestry duplication chain",
            "",
            "##Notes",
            "  - Toggles are persisted per world",
            "  - Requires admin privileges"
        )));
        allEntries.add(new WikiEntry("reliquary_vs_megamod_alchemy", "Reliquary vs. MegaMod Alchemy", "Reliquary", List.of(
            "##Why Reliquary replaced MegaMod Alchemy",
            "",
            "MegaMod previously shipped a custom Alchemy",
            "Cauldron + Alchemy Grindstone with its own",
            "reagent and potion set. That system has been",
            "removed in favour of Reliquary's Apothecary.",
            "",
            "##Why",
            "  - Overlap: both systems brewed custom potions",
            "  - Reliquary's Apothecary has more combinations",
            "  - Reliquary also ships cauldron/mortar blocks,",
            "    glowing water, condensed potions, tipped",
            "    arrows, and more",
            "",
            "##Migration",
            "  - MegaMod alchemy blocks no longer exist",
            "  - Build an Apothecary Mortar + Cauldron instead",
            "  - Reliquary brewing is NOT gated behind Arcane",
            "    skill tiers; it is open to all players"
        )));
        allEntries.add(new WikiEntry("reliquary_admin_commands", "Reliquary Admin Tab", "Reliquary", List.of(
            "##Reliquary Admin Tab",
            "",
            "The admin Computer has a dedicated Reliquary tab",
            "for server operators to manage the port.",
            "",
            "##Uses",
            "  - Spawn Reliquary items directly into inventory",
            "  - Fine-tune Handgun / relic toggles",
            "  - Inspect mob-charm drop rates",
            "  - Browse Alkahestry Tome recipe whitelist",
            "  - Reset pedestal automation state for debugging",
            "",
            "##Notes",
            "  - Requires admin privileges (NeverNotch, Dev)",
            "  - See also: 'Reliquary Toggles' entry"
        )));
    }
}
