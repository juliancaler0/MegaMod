...
public class AmbientVolume {
    ...
    /** Used to determine the volume of all the conditions. Included for mute value. Basically tells how good the conditions are met. */
    ...
    public String toString() {
        return AmbientDebugRenderer.DECIMAL_FORMAT.format(volume()) + "(" + AmbientDebugRenderer.DECIMAL_FORMAT.format(conditionVolume()) + ")";
    }
