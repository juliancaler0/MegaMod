package com.ultra.megamod.feature.ambientsounds.entity;
...
import com.ultra.megamod.feature.ambientsounds.condition.AmbientCondition.AmbientMinMaxFadeCondition;
...
public class AmbientEntityCondition {
        ...
        if (nbt != null) {
            ...
            for (String tag : nbt)
                try {
                    ...
                    MegaMod.LOGGER.error("Failed to parse entity NBT condition", e);
                }
        }
        ...
        if (badNbt != null) {
            ...
            for (String tag : badNbt)
                try {
                    ...
                    MegaMod.LOGGER.error("Failed to parse entity bad NBT condition", e);
                }
        }
    }
    ...
    private boolean hasNbt(List<CompoundTag> nbt, Entity entity) {
        // In 1.21.11, saveWithoutId takes ValueOutput, not CompoundTag. Use TagValueOutput to serialize.
