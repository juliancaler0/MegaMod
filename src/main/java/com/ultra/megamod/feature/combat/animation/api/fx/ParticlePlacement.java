...
/**
 * Defines particle spawn placement parameters for weapon trail effects.
 * Ported 1:1 from BetterCombat (net.bettercombat.api.fx.ParticlePlacement).
 */
public record ParticlePlacement(
    ...
    public ParticlePlacement(String particle_type, float x_addition, float y_addition, float z_addition,
                             float local_yaw, float pitch_addition, float roll_set) {
