...
public final class EquipmentSetDefinitions {
    ...
    public static List<EquipmentSetManager.EquipmentSet> buildAllSets() {
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("wizard_robe", "Wizard Robe",
            Set.of("megamod:wizard_robe_head", "megamod:wizard_robe_chest", "megamod:wizard_robe_legs", "megamod:wizard_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("arcane_robe", "Arcane Robe",
            Set.of("megamod:arcane_robe_head", "megamod:arcane_robe_chest", "megamod:arcane_robe_legs", "megamod:arcane_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("fire_robe", "Fire Robe",
            Set.of("megamod:fire_robe_head", "megamod:fire_robe_chest", "megamod:fire_robe_legs", "megamod:fire_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("frost_robe", "Frost Robe",
            Set.of("megamod:frost_robe_head", "megamod:frost_robe_chest", "megamod:frost_robe_legs", "megamod:frost_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_arcane_robe", "Netherite Arcane Robe",
            Set.of("megamod:netherite_arcane_robe_head", "megamod:netherite_arcane_robe_chest", "megamod:netherite_arcane_robe_legs", "megamod:netherite_arcane_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_fire_robe", "Netherite Fire Robe",
            Set.of("megamod:netherite_fire_robe_head", "megamod:netherite_fire_robe_chest", "megamod:netherite_fire_robe_legs", "megamod:netherite_fire_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_frost_robe", "Netherite Frost Robe",
            Set.of("megamod:netherite_frost_robe_head", "megamod:netherite_frost_robe_chest", "megamod:netherite_frost_robe_legs", "megamod:netherite_frost_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("paladin_armor", "Paladin Armor",
            Set.of("megamod:paladin_armor_head", "megamod:paladin_armor_chest", "megamod:paladin_armor_legs", "megamod:paladin_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("crusader_armor", "Crusader Armor",
            Set.of("megamod:crusader_armor_head", "megamod:crusader_armor_chest", "megamod:crusader_armor_legs", "megamod:crusader_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_crusader_armor", "Netherite Crusader Armor",
            Set.of("megamod:netherite_crusader_armor_head", "megamod:netherite_crusader_armor_chest", "megamod:netherite_crusader_armor_legs", "megamod:netherite_crusader_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("priest_robe", "Priest Robe",
            Set.of("megamod:priest_robe_head", "megamod:priest_robe_chest", "megamod:priest_robe_legs", "megamod:priest_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("prior_robe", "Prior Robe",
            Set.of("megamod:prior_robe_head", "megamod:prior_robe_chest", "megamod:prior_robe_legs", "megamod:prior_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_prior_robe", "Netherite Prior Robe",
            Set.of("megamod:netherite_prior_robe_head", "megamod:netherite_prior_robe_chest", "megamod:netherite_prior_robe_legs", "megamod:netherite_prior_robe_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("rogue_armor", "Rogue Armor",
            Set.of("megamod:rogue_armor_head", "megamod:rogue_armor_chest", "megamod:rogue_armor_legs", "megamod:rogue_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("assassin_armor", "Assassin Armor",
            Set.of("megamod:assassin_armor_head", "megamod:assassin_armor_chest", "megamod:assassin_armor_legs", "megamod:assassin_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_assassin_armor", "Netherite Assassin Armor",
            Set.of("megamod:netherite_assassin_armor_head", "megamod:netherite_assassin_armor_chest", "megamod:netherite_assassin_armor_legs", "megamod:netherite_assassin_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("warrior_armor", "Warrior Armor",
            Set.of("megamod:warrior_armor_head", "megamod:warrior_armor_chest", "megamod:warrior_armor_legs", "megamod:warrior_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("berserker_armor", "Berserker Armor",
            Set.of("megamod:berserker_armor_head", "megamod:berserker_armor_chest", "megamod:berserker_armor_legs", "megamod:berserker_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_berserker_armor", "Netherite Berserker Armor",
            Set.of("megamod:netherite_berserker_armor_head", "megamod:netherite_berserker_armor_chest", "megamod:netherite_berserker_armor_legs", "megamod:netherite_berserker_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("archer_armor", "Archer Armor",
            Set.of("megamod:archer_armor_head", "megamod:archer_armor_chest", "megamod:archer_armor_legs", "megamod:archer_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("ranger_armor", "Ranger Armor",
            Set.of("megamod:ranger_armor_head", "megamod:ranger_armor_chest", "megamod:ranger_armor_legs", "megamod:ranger_armor_boots"),
            List.of(
        ...
        sets.add(new EquipmentSetManager.EquipmentSet("netherite_ranger_armor", "Netherite Ranger Armor",
            Set.of("megamod:netherite_ranger_armor_head", "megamod:netherite_ranger_armor_chest", "megamod:netherite_ranger_armor_legs", "megamod:netherite_ranger_armor_boots"),
            List.of(
