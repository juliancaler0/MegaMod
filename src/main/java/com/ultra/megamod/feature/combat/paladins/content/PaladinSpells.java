...
public class PaladinSpells {
    ...
    private static Entry flash_heal() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "flash_heal");
        ...
        SpellBuilder.Cost.item(spell, "megamod:healing_rune");
    ...
    private static Entry divine_protection() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "divine_protection");
    ...
    private static Entry judgement() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "judgement");
        var title = "Judgement";
        var description = "";
        ...
        model.model_id = "megamod:spell_projectile/judgement";
        model.scale = 1.2F;
    ...
    private static Entry battle_banner() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "battle_banner");
        ...
        cloud.client_data.model.model_id = "megamod:spell_effect/battle_banner";
    ...
    private static Entry heal() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "heal");
        var title = "Heal";
        var description = "";
    ...
    private static Entry holy_shock() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "holy_shock");
    ...
    private static Entry holy_beam() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "holy_beam");
    ...
    private static Entry circle_of_healing() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "circle_of_healing");
    ...
    private static Entry barrier() {
        var id = Identifier.fromNamespaceAndPath(MegaMod.MODID, "barrier");
        var title = "Barrier";
        var description = "";
