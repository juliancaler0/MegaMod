...
public class DealerRenderer
extends AgeableMobRenderer<DealerEntity, VillagerRenderState, VillagerModel> {
    private static final Identifier VILLAGER_BASE_SKIN = Identifier.withDefaultNamespace("textures/entity/villager/villager.png");

    public DealerRenderer(EntityRendererProvider.Context ctx) {
    ...
    public void extractRenderState(DealerEntity entity, VillagerRenderState renderState, float partialTick) {
