...
public class SpearItem extends Item {
    ...
    public SpearItem(Item.Properties props) {
        super(props.stacksTo(1).durability(600).rarity(Rarity.UNCOMMON));
    }
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext context, TooltipDisplay display, Consumer<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.accept(Component.literal("A long-reaching spear").withStyle(ChatFormatting.WHITE));
        tooltip.accept(Component.empty());
        tooltip.accept(Component.literal("Moderate damage, moderate speed").withStyle(ChatFormatting.GRAY));
