...
public class KunaiEntity extends AbstractArrow {
    ...
    public static KunaiEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
        KunaiEntity entityarrow = new KunaiEntity(DungeonEntityRegistry.KUNAI.get(), entity, world);
    ...
    public static KunaiEntity shoot(LivingEntity entity, LivingEntity target) {
        KunaiEntity entityarrow = new KunaiEntity(DungeonEntityRegistry.KUNAI.get(), entity, entity.level());
