...
/**
 * Tab module for rendering sidebar tab buttons on building windows.
...
public class TabsWindowModule implements IWindowModule
{
    ...
    public enum TabImageSide
    {
        ...
        {
            return Identifier.fromNamespaceAndPath("megamod", String.format("textures/gui/modules/tab_%s_side%d.png", side, random.nextInt(imageCount) + 1));
        }
    }
}
