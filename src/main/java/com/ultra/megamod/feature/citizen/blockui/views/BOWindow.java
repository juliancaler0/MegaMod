package com.ultra.megamod.feature.citizen.blockui.views;
...
public class BOWindow extends View
{
    ...
    /**
     * Render using size or attempt to scale to fullscreen.
     */
    ...
    public void drawSelf(final BOGuiGraphics ms, final double mx, final double my)
    {
        ...
        debugging = (GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_LEFT_SHIFT) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_RIGHT_SHIFT) == GLFW.GLFW_PRESS)
            && (GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_LEFT_ALT) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_RIGHT_ALT) == GLFW.GLFW_PRESS)
            && (GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_LEFT_CONTROL) == GLFW.GLFW_PRESS || GLFW.glfwGetKey(windowHandle, GLFW.GLFW_KEY_RIGHT_CONTROL) == GLFW.GLFW_PRESS);
    ...
    public enum WindowRenderType
    {
        ...
        /**
         * no upscaling, no downscaling, max gui resolution is unlimited
         */
