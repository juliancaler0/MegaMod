...
{
    private static final MapCodec<ToggleableTextComponent> CODEC = MapCodec.unit(new ToggleableTextComponent(() -> true, net.minecraft.network.chat.Component.empty().copy()));
