...
/**
 * Drowned pirate archer — ranged, water breathing, bow.
 */
public class EntityDrownedArcherPirate extends AbstractRaiderEntity {

    public EntityDrownedArcherPirate(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    ...
    public static AttributeSupplier.Builder createDrownedArcherPirateAttributes() {
