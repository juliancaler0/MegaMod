...
/**
 * Pirate melee raider — iron sword, gold armor.
 */
public class EntityPirate extends AbstractRaiderEntity {

    public EntityPirate(EntityType<? extends Monster> type, Level level) {
        super(type, level);
    ...
    public static AttributeSupplier.Builder createPirateAttributes() {
