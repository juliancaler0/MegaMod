...
import com.ultra.megamod.feature.citizen.blockui.util.SpacerTextComponent.FormattedSpacerComponent;
import com.ultra.megamod.feature.citizen.blockui.util.ToggleableTextComponent;
import com.ultra.megamod.feature.citizen.blockui.util.ToggleableTextComponent.FormattedToggleableCharSequence;
...
public abstract class AbstractTextElement extends Pane
{
    ...
    public static final int DEFAULT_TEXT_COLOR = 0xFFffffff; // white with full alpha (MC 1.21.11 requires alpha)
    ...
    protected void innerDrawSelf(final BOGuiGraphics target, final double mx, final double my)
    {
        ...
        final int rawColor = isEnabled() ? (wasCursorInPane ? textHoverColor : textColor) : textDisabledColor;
        // Ensure alpha is set - MC 1.21.11 Font.drawInBatch treats 0 alpha as fully transparent
        final int color = (rawColor & 0xFF000000) == 0 ? (rawColor | 0xFF000000) : rawColor;
        ...
        // Linear filtering computation removed in 1.21.11 - the new rendering pipeline handles this
        ...
        // Linear filtering and blend state cleanup removed in 1.21.11
