...
/**
 * Resolves HUD positions into (x, y) screen coordinates and delegates rendering
 * to the individual {@link Component} panes. Name kept with original typo for
 * parity with the upstream Reliquary source.
 */
public final class HUDRenderrer {
