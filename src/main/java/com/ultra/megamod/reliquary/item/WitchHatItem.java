...
public class WitchHatItem extends Item implements ICreativeTabItemGenerator {
	...
	public Component getName(ItemStack stack) {
		// Port note (1.21.11): Item#getDescriptionId(ItemStack) removed — final
		// no-arg variant is the only one left.
		return Component.translatable(getDescriptionId()).withStyle(ChatFormatting.YELLOW);
	}
}
